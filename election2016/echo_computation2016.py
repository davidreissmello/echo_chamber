...
data = pd.read_csv('All_Gender_Location_Political_Echochambers_Subset__Friends__BrandID_FollowerID_FriendID.csv', sep = '\t')
...
for candidate in CANDIDATES:
	...
	for follower in candidate_df.followers.unique():
		...
		followers1_that_follow_candidate_opponent = followers1_that_follow_candidate.intersection(followers1_that_follow_opponent)
